...
"""
 ...
 Copyright
     ...
     gen_signal is free software: you can redistribute it and/or
     modify it under the terms of the GNU General Public License as published
     by the Free Software Foundation, either version 3 of the License, or
     (at your option) any later version.
     gen_signal is distributed in the hope that it will be useful,
 ...
 Info
     Define setup for tool gen_signal.
"""
...
setup(
    name='gen_signal',
    version='1.0.0',
    description='Generating Signal modules',
    author='Vladimir Roncevic',
    author_email='elektron.ronca@gmail.com',
    url='https://vroncevic.github.io/gen_signal',
    license='GPL 2021 Free software to use and distributed it.',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    keywords='Unix, Linux, Development, Signal, Modules',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=[
        'gen_signal', 'gen_signal.pro',
        'gen_signal.pro.config'
    ],
    install_requires=['ats-utilities'],
    package_data={
        'gen_signal': [
            'conf/gen_signal.logo',
            'conf/gen_signal.cfg',
            'conf/gen_signal_util.cfg',
            'conf/project.yaml',
    ...
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/gen_signal_run.py')
        ]
    )]
)
